...
*************************************** PONTI 5/12/2019 *********************************              
               real, allocatable :: ponte(:)  ! 5/12/2019  BERNARD PONTI
               real, allocatable :: quota_critica_ponte(:,:)  ! 5/12/2019 BERNARD PONTI
               real, allocatable :: file_ponti(:,:)  ! 5/12/2019 BERNARD PONTI
               real, allocatable :: ele_ponti(:,:)  ! 5/12/2019 BERNARD PONTI
               real, allocatable :: diff_ponti(:,:)  ! 5/12/2019 BERNARD PONTI
               real, allocatable :: codice_ponte(:)  ! 5/12/2019 BERNARD PONTI
               real, allocatable :: soletta(:)  ! 5/12/2019 BERNARD PONTI
               real, allocatable :: franco(:)  ! 5/12/2019 BERNARD PONTI
               real, allocatable :: ponte_ostruito(:)  ! 5/12/2019 BERNARD PONTI
               real, allocatable :: volume_ostruzione(:)  ! 5/12/2019 BERNARD PONTI
************************************************************************
...
c      erosione/deposito per differenze di altezza
	...
	character*5256 fileStrutture ! aggiunta del 21/09/2015
      ...
      character*5256 fileTxtOpenings, fileTxtBoulders ! BERNARD INTASAMENTO BRIGLIA
...
*************************************** INTASAMENTO BRIGLIA 27/2/2023 *********************************
      logical richiamaSubIntasamento
      integer N_aperture,Nclassi_massi, N_massiMAX, N_briglie
      real briglieMax
      real, allocatable :: codice_apertura (:), largh_Apertura(:)
      real, allocatable :: h_Apertura(:),missing_hsed(:,:),mod_hsed(:,:)
      real, allocatable :: Dmin_massi(:),Dmax_massi(:),Dmedio_massi(:)
      real, allocatable :: N_massi(:), Vref_massi(:), Vmedio_massi(:)
      real, allocatable :: p_massi(:,:)
      real, allocatable :: ele_iniz_orig(:,:)
      integer, allocatable :: ic_aperture(:,:) ! 
      integer, allocatable :: ir_aperture(:,:) ! 
      integer, allocatable :: N_celle_aperture(:)
      integer, allocatable :: intasata(:)
      integer, allocatable :: indexBriglia(:)
      integer, allocatable :: counter_passingBoulders(:,:)
      real, allocatable :: ele_iniz_medio_apertura(:)
      real, allocatable :: volume_TransitatoBriglie(:)
      real, allocatable :: ele_medio_apertura (:), h_medio_apertura(:)
!      real, allocatable :: spessore_medio_apertura(:)
